...
public class MissingFieldsPanel extends FunctionPanel
{
	...
	private void init()
	{
		...
		chckFixMissing.addChangeListener(new ChangeListener()
		{
		...
		chckTrackCount.addChangeListener(new ChangeListener()
		{
			public void stateChanged(ChangeEvent e)
			{
				chckIncNonEmpty.setEnabled(chckTrackCount.isSelected());
			}
		});
	}
	...
	{
		ArrayList<FieldKey> fieldKeys = new ArrayList<FieldKey>();
